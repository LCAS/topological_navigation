...
* Replace install -> catkin_install_python in CMakeLists
  ...
  Python2
* Merge pull request `#21 <https://github.com/SAGARobotics/topological_navigation/issues/21>`_ from adambinch/melodic-devel
  Bayes topo localisation up to date with lcas version
* Bayes topo localisation up to date with lcas version
